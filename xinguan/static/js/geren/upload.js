function DragImgUpload(id, options) {
    ...
    this.preview = $('<div id="preview"><img src="/static/image/upload.png" class="img-responsive"  style="width: 100%;height: auto;" alt="" title=""> </div>');
...
DragImgUpload.prototype = {
    ...
    onDrop: function (e) {
        ...
        var filesize = Math.floor((fileList[0].size
        ) / 1024);
        if (filesize > 500) {
            alert("上传大小不能超过500K.");
            return false;
